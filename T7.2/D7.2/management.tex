...
\item[Rodin and Plugin.] See \ref{sec:EventB_m}. Rodin is an open source tool based on Eclipse dedicaded to formal  design. It includes ProR as plugin to  manage direct traceability between requirements and formal models.
...
\subsection{EventB, Rodin and plugins}
\label{sec:EventB_m}
...
A number of technologies have been idenitfied and are currently discussed in toolchain issue \#216 (\url{https://github.com/openETCS/toolchain/issues/216}).
