...
\begin{abstract}
This document gives results of the evaluation and selectionof  the tools and methods to complete the primary toolchain and to support verification and validation activities, safety activities, model transformation and data management for the whole project.
