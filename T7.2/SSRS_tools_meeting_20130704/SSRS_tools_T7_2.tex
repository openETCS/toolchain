...
\title[SSRS tool meeting T7.2] % (optional, use only with long paper titles)
{Meeting on means and tools for SSRS}
...
\subject{OpenETCS WP7-T7.2 SSRS Means and Tools Meeting}
