...
\item[***] Scalability is difficult to judge. As with most tools for model checking it is important how a system model is specified (e.g., bounded datatypes, etc.).
\end{description}
\end{author_comment}
