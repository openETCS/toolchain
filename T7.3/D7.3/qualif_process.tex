...
\hline \multicolumn{1}{|c|}{Role} & \multicolumn{1}{|c|}{Responsibilities} & \multicolumn{1}{|c|}{Skills} \\ \hline 
\endfirsthead
...
\item Experience in analysing dependences between different tools
\end{itemize}
\\\hline
...
\end{itemize}
& \begin{itemize}
\item Experience building up automated platforms for incomplete toolchains
