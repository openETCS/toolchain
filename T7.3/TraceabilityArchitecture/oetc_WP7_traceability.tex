...
\cite{D4.2.3} presents the 5 phases of the openETCS software development process and describes in table \ref{tab:DevelopmentPhases} how they are supported by tools. 
