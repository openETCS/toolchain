 ...
 * <ul>
 *   <li>{@link Subset0268.impl.ListTypeImpl#getMedia <em>Media</em>}</li>
 *   <li>{@link Subset0268.impl.ListTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link Subset0268.impl.ListTypeImpl#getNumber <em>Number</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ListTypeImpl extends MinimalEObjectImpl.Container implements ListType {
	...
	protected EClass eStaticClass() {
		return Subset0268Package.Literals.LIST_TYPE;
	}
	...
	public void setMedia(String newMedia) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Subset0268Package.LIST_TYPE__MEDIA, oldMedia, media));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Subset0268Package.LIST_TYPE__NAME, oldName, name));
	}
	...
	public void setNumber(int newNumber) {
		...
		numberESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Subset0268Package.LIST_TYPE__NUMBER, oldNumber, number, !oldNumberESet));
	}
	...
	public void unsetNumber() {
		...
		numberESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Subset0268Package.LIST_TYPE__NUMBER, oldNumber, NUMBER_EDEFAULT, oldNumberESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Subset0268Package.LIST_TYPE__MEDIA:
				return getMedia();
			case Subset0268Package.LIST_TYPE__NAME:
				return getName();
			case Subset0268Package.LIST_TYPE__NUMBER:
				return getNumber();
		}
