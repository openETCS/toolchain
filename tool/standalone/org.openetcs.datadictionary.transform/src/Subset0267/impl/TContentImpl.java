 ...
 * <ul>
 *   <li>{@link Subset0267.impl.TContentImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link Subset0267.impl.TContentImpl#getTlgVar <em>Tlg Var</em>}</li>
 *   <li>{@link Subset0267.impl.TContentImpl#getLoopDoWhile <em>Loop Do While</em>}</li>
 *   <li>{@link Subset0267.impl.TContentImpl#getLoopWhile <em>Loop While</em>}</li>
 *   <li>{@link Subset0267.impl.TContentImpl#getConditional <em>Conditional</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TContentImpl extends MinimalEObjectImpl.Container implements TContent {
	...
	protected EClass eStaticClass() {
		return Subset0267Package.Literals.TCONTENT;
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, Subset0267Package.TCONTENT__GROUP);
		}
		return group;
	}
	...
	public EList<TTlgVar> getTlgVar() {
		return getGroup().list(Subset0267Package.Literals.TCONTENT__TLG_VAR);
	}
	...
	public EList<TLoopDoWhile> getLoopDoWhile() {
		return getGroup().list(Subset0267Package.Literals.TCONTENT__LOOP_DO_WHILE);
	}
	...
	public EList<TLoopWhile> getLoopWhile() {
		return getGroup().list(Subset0267Package.Literals.TCONTENT__LOOP_WHILE);
	}
	...
	public EList<TConditional> getConditional() {
		return getGroup().list(Subset0267Package.Literals.TCONTENT__CONDITIONAL);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Subset0267Package.TCONTENT__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case Subset0267Package.TCONTENT__TLG_VAR:
				return ((InternalEList<?>)getTlgVar()).basicRemove(otherEnd, msgs);
			case Subset0267Package.TCONTENT__LOOP_DO_WHILE:
				return ((InternalEList<?>)getLoopDoWhile()).basicRemove(otherEnd, msgs);
			case Subset0267Package.TCONTENT__LOOP_WHILE:
				return ((InternalEList<?>)getLoopWhile()).basicRemove(otherEnd, msgs);
			case Subset0267Package.TCONTENT__CONDITIONAL:
