 ...
 * <ul>
 *   <li>{@link Subset0267.impl.TTrackToTrainImpl#getList <em>List</em>}</li>
 *   <li>{@link Subset0267.impl.TTrackToTrainImpl#getPacket <em>Packet</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TTrackToTrainImpl extends MinimalEObjectImpl.Container implements TTrackToTrain {
	...
	protected EClass eStaticClass() {
		return Subset0267Package.Literals.TTRACK_TO_TRAIN;
	}
	...
	public EList<ListType> getList() {
		if (list == null) {
			list = new EObjectContainmentEList<ListType>(ListType.class, this, Subset0267Package.TTRACK_TO_TRAIN__LIST);
		}
		return list;
	}
	...
	public EList<TPacket> getPacket() {
		if (packet == null) {
			packet = new EObjectContainmentEList<TPacket>(TPacket.class, this, Subset0267Package.TTRACK_TO_TRAIN__PACKET);
		}
		return packet;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Subset0267Package.TTRACK_TO_TRAIN__LIST:
				return ((InternalEList<?>)getList()).basicRemove(otherEnd, msgs);
			case Subset0267Package.TTRACK_TO_TRAIN__PACKET:
