 ...
 * <ul>
 *   <li>{@link Subset0267.TVariables#getGroup <em>Group</em>}</li>
 *   <li>{@link Subset0267.TVariables#getLoopDoWhile <em>Loop Do While</em>}</li>
 *   <li>{@link Subset0267.TVariables#getLoopWhile <em>Loop While</em>}</li>
 *   <li>{@link Subset0267.TVariables#getTlgVar <em>Tlg Var</em>}</li>
 *   <li>{@link Subset0267.TVariables#getConditional <em>Conditional</em>}</li>
 * </ul>
 * </p>
 *
 * @see Subset0267.Subset0267Package#getTVariables()
...
public interface TVariables extends EObject {
	 ...
	 * @see Subset0267.Subset0267Package#getTVariables_Group()
	 ...
	 * @see Subset0267.Subset0267Package#getTVariables_LoopDoWhile()
	 ...
	 * @see Subset0267.Subset0267Package#getTVariables_LoopWhile()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see Subset0267.Subset0267Package#getTVariables_TlgVar()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see Subset0267.Subset0267Package#getTVariables_Conditional()
	 * @model containment="true" transient="true" volatile="true" derived="true"
