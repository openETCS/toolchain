 ...
 * <ul>
 *   <li>{@link ClassicalB.impl.BParameterImpl#getName <em>Name</em>}</li>
 *   <li>{@link ClassicalB.impl.BParameterImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BParameterImpl extends MinimalEObjectImpl.Container implements BParameter {
	...
	protected EClass eStaticClass() {
		return ClassicalBPackage.Literals.BPARAMETER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassicalBPackage.BPARAMETER__NAME, oldName, name));
	}
	...
	public BType getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ClassicalBPackage.BPARAMETER__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ClassicalBPackage.BPARAMETER__NAME:
				return getName();
			case ClassicalBPackage.BPARAMETER__TYPE:
