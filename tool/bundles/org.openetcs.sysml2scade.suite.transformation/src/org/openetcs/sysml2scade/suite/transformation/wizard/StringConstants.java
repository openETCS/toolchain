...
public interface StringConstants {
	...
	public final String UI_MESSAGE_ERRORS_IN_MODEL = "The SysML model contains some errors. Do you really want to generate the SCADE Suite Project?";
	public final String UI_TRACED_PROJECT_MISSING = "The Project is tracked but does not exist anymore. Do you wish to delete the traces?";
}