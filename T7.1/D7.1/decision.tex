...
\decision{A case study will be defined that should allow us to better understand the pros and cons of the B and EFS toolchains.  It should be small enough to allow modeling and evaluation before the end of 2013.}
...
\decision{The EFS and B toolchains shall clarify their architecture, keep it as modular as possible and align interfaces between the two wherever it makes sense.}
