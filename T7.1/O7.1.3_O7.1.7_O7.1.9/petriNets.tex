...
\begin{description}
\item[Name] \todo{means of description: Coloures Petri nets; tool: CPN Tools}
\item[Web site] \todo{http://cpntools.org}
\item[Licence] \todo{CPN Tools GUI: GNU GPL version 2; Simulator: GNU GPL version 2 andBSD license; Access/CPN: GNU LGPL version 2.1}
\end{description}
