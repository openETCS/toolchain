...
\marginpar{(Systerel) Why to restrict the use of formal méthods to verification and code generation ? Formal methods can be use at the earliest steps of the design to validate models and to  verify  traceability between steps.} The tool chain must support the following tasks:
