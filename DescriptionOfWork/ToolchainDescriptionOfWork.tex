...
\paragraph{(SP) I would suggest to remove that subtask.}
- This belongs to WP2.
...
\paragraph{(ALL4TEC) Christophe Gaston comments} address several previous chapters of the DOW. It could be useful to re dispatch them.
