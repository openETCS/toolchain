...
is concerned with the language itself \marginpar{MPA: should be plural as
  several languages will probably be required to express all the
  concerns}, the tool for authoring, as well as the method used for
formalising the specification \marginpar{MPA: Should also be plural as there
  will be several tools and associated methods}.
...
\marginpar{(ALL4TEC) ALL4TEC is candidate to contribute for modeling on the
basis of Subset 026 for example \ldots}
