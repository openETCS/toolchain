...
basis of Subset 026 for example …}
...
The languages and tools \marginpar{MPA: Should both be plural} of choice have to be complemented to support a number of activities that are crucial for the project.
...
\marginpar{irit-laas: we agree with the proposal from CEA and their
