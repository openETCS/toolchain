...
\affiliation{WP3.1 Task Leader (Core Tool Chain Analyses and Recommendations)}
  
\author{Jan Peleska}

\affiliation{WP3.3 Task Leader (Define and Develop Tool Chain)}

\author{Jonas Helming}

\affiliation{WP3.3 Task Leader (Develop Open Source Ecosystem)}
